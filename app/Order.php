...
class Order extends Model
{
    ...
    {
        return $this->belongsToMany('App\Items','order_has_items','order_id','item_id')->withPivot(['qty','extras']);
    }
    public function orderItems()
    {
        return $this->hasMany('App\OrderHasItem','order_id','id')->with('item','itemHasExtras','itemHasSubItems');
    }
