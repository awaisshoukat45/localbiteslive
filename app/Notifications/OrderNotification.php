...
class OrderNotification extends Notification
{
    ...
    public function toTwilio($notifiable)
    {
        if($this->status.""=="1"){
            ...
            //Rejected
            $line=__('Order Completed. We donate 20% of our profits to buy food for the food bank.');
        }
    ...
    public function toOneSignal($notifiable)
    {
        ...
        if($this->status.""=="1"){
            ...
            //Rejected
            $greeting=__('Order Completed');
            $line=__('We donate 20% of our profits to buy food for the food bank.');
        }
