...
class Items extends Model
{
    ...
    {
        return $this->hasMany('App\Extras','item_id','id')->with('extrasGroup');
    }
    public function ingredients()
    {
        return $this->hasMany('App\FoodIngredientItem','item_id','id');
    }
    public function subItems()
    {
        return $this->hasMany('App\FoodIngredientItem','item_id','id')->with('ingredientGroup');
    }
