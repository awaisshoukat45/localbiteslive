<ul class="navbar-nav">
                ...
                <!--
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('plans.index') }}">
                            <i class="ni ni-credit-card text-orange"></i> {{ __('Subscriptions') }}
                        </a>
                    </li>
                -->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('extra-groups.index') }}">

                        <i class="ni ni-fat-add"></i> {{ __('Extra Groups') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('notifications.index') }}">
                        <i class="ni ni-settings text-black"></i> {{ __('Notification Alert') }}
                    </a>
                </li>
                ...
                @if (env('is_demo',false))
                    <li class="nav-item">
                        <a class="nav-link" target="_blank" href="#">
                            <i class="ni ni-active-40 text-black"></i> {{ __('ENV Editor') }} ( disabled in demo )
                        </a>
                    </li>
                @else
                    <li class="nav-item">
