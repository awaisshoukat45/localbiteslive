    ...
    <div class="container mt--350">
        ...
        @if(env('is_demo', false))
                    <div class="row">
                        ...
                        <div class=""> <span class="description "><strong>Demo info</strong>: Our demo restaurants deliver in: <a href="?location=Bronx,NY,USA">Bronx</a>, <a href="?location=Manhattan, New York, NY, USA">Manhattn</a>, <a href="?location=Queens, New York, NY, USA">Queens</a>, <a href="?location=Brooklyn, New York, NY, USA">Brooklyn</a></span></div>
                    </div>
                    <br />
                @endif
        <div class="row">
