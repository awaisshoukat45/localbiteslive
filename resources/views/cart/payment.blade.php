                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <br>
                            <span class="donateParagraph">We donate 20% of our profits to buy food for the food bank. </span>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col">
                    ...
                    @endif
                    @if (env('PAYPAL_CLIENT_ID',True))
                          <div class="custom-control custom-radio mb-3">
                              <input name="paymentType" class="custom-control-input" id="paymentPaypal" type="radio" value="paypal" {{ env('DEFAULT_PAYMENT','paypal')=="paypal"?"checked":""}}>
                              <label class="custom-control-label" for="paymentPaypal"><span class="delTime">{{ __('Pay with Paypal') }}</span> <span class="picTime">{{ __('Pay with Paypal') }}</span></label>
                          </div>
                    @endif
